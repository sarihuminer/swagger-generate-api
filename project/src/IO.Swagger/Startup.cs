    ...
    public class Startup
    {
      ...
      .AddJwtBearer(options =>
      {
          options.TokenValidationParameters = new TokenValidationParameters
          {
              ...
              ValidIssuer = "issuer-details",
              ValidAudience = "audience-details",
              IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("key-details"))
          };
      });
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.DocumentFilter<BasePathFilter>("/test79642/Lehumi/1.0.0");
